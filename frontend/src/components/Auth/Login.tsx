  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-primary-900/50" />
        <div className="relative z-10 text-center">
          ...
          <p className="text-primary-200 text-lg">Organise your work and life</p>
          <div className="mt-10 grid grid-cols-2 gap-4 text-left">
            {["Priority management","Due date tracking","Dark mode support","Category filters"].map(f => (
      ...
      <div className="flex-1 flex items-center justify-center bg-slate-50 dark:bg-[#0f1117] px-6">
        <div className="w-full max-w-md fade-up">
          <div className="mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1 text-sm">Sign in to continue to TaskFlow</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link to="/forgotPassword" className="text-sm text-primary-600 dark:text-primary-400 hover:underline font-medium">
                Forgot password?
              </Link>
            </div>
